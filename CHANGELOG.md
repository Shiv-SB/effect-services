...
- Updated Effect target version to `4.0.0-beta.83`.
- Updated all dev & peer dependencies.
...
- Replaced instances of `...() => Effect.gen() ...` with `Effect.fn`.
- Hardcode git tag in package.json.
